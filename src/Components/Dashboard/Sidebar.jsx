    ...
    return (
            <>
                ...
                <div className='bg-gray-100  text-gray-800 flex justify-between md:hidden'>
                    ...
                    <button onClick={handleToggle} className=' p-4  focus:bg-gray-200'>
                        <AiOutlineBars className='h-5 w-5' />
                    </button>
                </div>
                {/* Sidebar */}
                <div className={`z-10 md:fixed flex flex-col bg-gray-100 w-64 h-full px-2 py-4 absolute transform ${isActive && '-translate-x-full'
